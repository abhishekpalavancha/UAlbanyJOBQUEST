						...
						<div class="col-md-12">
							...
							<div class="portlet box purple">
								...
								<div class="portlet-body form">
									...
									<c:forEach items="${sessionScope.edit }" var="a">
									<form action="<%=request.getContextPath() %>/category" method="get" class="form-horizontal">
										...
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-4">
													<input type="text" name="categoryname" value="${a.cat_Name}" data-required="1"
											...
											<div class="form-group">
												...
												<div class="col-md-4">
													<textarea type="text" name="categorydescription" data-required="1"
														class="form-control" required="required ">${a.cat_Desc}</textarea>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit"  value="update" class="btn green">Submit</button>
													<button type="reset" class="btn default">Cancel</button>
													
													<input type="hidden" name="categoryId" value="${a.cat_Id}">
