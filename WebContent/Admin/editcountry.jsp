...
<link href="${pageContext.request.contextPath}/Admin/css/bootstrap-switch.min.css" rel="stylesheet"
	type="text/css" />
...
<link id="style_color" href="css/default.css" rel="stylesheet"
	type="text/css" />
						...
						<div class="col-md-12">
							...
							<div class="portlet box purple">
								...
								<div class="portlet-body form">
									...
									<p:forEach var="a" items="${sessionScope.edit}" >
									
									<form action="<%=request.getContextPath()%>/country" method="get" class="form-horizontal">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3">Country Name <span
													class="required"> * </span> </label>
												<div class="col-md-4">
													<input type="text" name="countryname" data-required="1"
														class="form-control" required="required" value="${a.country_Name}"/>
												</div>
											</div>
											
											<div class="form-group">
												<label class="control-label col-md-3">Country Description <span
													class="required"> * </span> </label>
												<div class="col-md-4">
													<textarea type="text" name="countrydescription" data-required="1"
														class="form-control" required="required" >${a.country_Desc}</textarea>
												</div>
											</div>
											<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit" value="updated" class="btn green">Submit</button>
													<button type="reset" class="btn default">Cancel</button>
												</div>
											</div>
										</div>
											<input type="hidden" name="countryId" value="${a.country_Id}">
